...
class ClienteService {
  ...
  Future<List<Cliente>> buscarId() {
    return Future.delayed(
        Duration(seconds: 10), () => repository.buscarPorID());
  }

  Future<List<Cliente>> excluirDados() {
    return Future.delayed(Duration(seconds: 10), () => repository.excluir());
  }
}
